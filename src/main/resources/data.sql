INSERT INTO users (user_id, username, password, enabled, role) VALUES
	('0', 'admin@example.com', '$2a$10$D4OLKI6yy68crm.3imC9X.P2xqKHs5TloWUcr6z5XdOqnTrAK84ri', true, 'ROLE_ADMIN'),
	...
	('4', 'signup', '$2a$10$D4OLKI6yy68crm.3imC9X.P2xqKHs5TloWUcr6z5XdOqnTrAK84ri', true, 'ROLE_SIGNUP');
